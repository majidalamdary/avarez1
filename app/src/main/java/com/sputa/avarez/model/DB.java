...
public class DB
{
    ...
    public static String query="" +
            ...
            "INSERT INTO  water (AboneID, ID, FirstName, LastName, CellPhoneNumber, StartDate, EndDate, StartNumber, EndNumber, UsedWater, Fazelab, Tax, Budget, Debit, Amount) VALUES ('5615328', '2889951782', 'خضر', 'خضری', 9141672311, '1397/06/01', '1397/08/01', 300, 400, 1100, 120000, 12000, 1000, 0, 310000);" +
            "INSERT INTO  water (AboneID, ID, FirstName, LastName, CellPhoneNumber, StartDate, EndDate, StartNumber, EndNumber, UsedWater, Fazelab, Tax, Budget, Debit, Amount) VALUES ('5613436', '5230043814', 'مجتبی ', 'کمالی', 9159250971, '1397/06/01', '1397/08/01', 6000, 7200, 1100, 120000, 12000, 1000, 0, 370000);" +
            "" +
